      ...
      <div className='container mx-auto px-6 relative z-10'>
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          ...
          <div className='space-y-4 text-muted-foreground animate-fade-in animation-delay-200'>
            ...
            <p>
              Over time, I've built projects like an AI Code Reviewer, an AI Image Generation platform, and a Virtual Keyboard using Hand Gesture Recognition. Along with development, I'm also improving my problem-solving skills through DSA and competitive programming.
            </p>
          </div>
